...
// Typed (`module:`-loaded) TSX views report their module path as the
// view name, not the dotted namespace form, so OPA's `viewName` matcher
// must use the module form to resolve the Main view.
const viewName = "module:ui5/community/jsx/helloworld/view/Main";
