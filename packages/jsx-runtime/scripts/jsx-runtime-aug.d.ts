...
declare module "ui5/community/jsx/runtime/jsx-runtime" {
	...
	export namespace JSX {
		...
		export type HtmlBaseAttributes = DeepJSX.HtmlBaseAttributes;
		export type AnchorAttributes = DeepJSX.AnchorAttributes;
		export type ButtonHtmlAttributes = DeepJSX.ButtonHtmlAttributes;
		export type ImgAttributes = DeepJSX.ImgAttributes;
		export type InputAttributes = DeepJSX.InputAttributes;
		export type LabelHtmlAttributes = DeepJSX.LabelHtmlAttributes;
		export type SelectAttributes = DeepJSX.SelectAttributes;
		export type TextareaAttributes = DeepJSX.TextareaAttributes;
		export type FormAttributes = DeepJSX.FormAttributes;
		export type TableHtmlAttributes = DeepJSX.TableHtmlAttributes;
		export type TableCellAttributes = DeepJSX.TableCellAttributes;
		export type ColAttributes = DeepJSX.ColAttributes;
		export type LiAttributes = DeepJSX.LiAttributes;
		export type OlAttributes = DeepJSX.OlAttributes;
		export type DetailsAttributes = DeepJSX.DetailsAttributes;
		export type MeterAttributes = DeepJSX.MeterAttributes;
		export type ProgressAttributes = DeepJSX.ProgressAttributes;
		export type TimeAttributes = DeepJSX.TimeAttributes;
		export type DataAttributes = DeepJSX.DataAttributes;
		export type OptionAttributes = DeepJSX.OptionAttributes;
		export type OptgroupAttributes = DeepJSX.OptgroupAttributes;
		export type FieldsetAttributes = DeepJSX.FieldsetAttributes;
		export type MapAttributes = DeepJSX.MapAttributes;
		export type AreaAttributes = DeepJSX.AreaAttributes;
		export type CanvasAttributes = DeepJSX.CanvasAttributes;
